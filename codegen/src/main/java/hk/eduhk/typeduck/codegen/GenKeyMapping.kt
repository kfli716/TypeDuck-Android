package hk.eduhk.typeduck.codegen
...
//            0x007e to KeyEvent.KEYCODE_ASCIITILDE, /* U+007E TILDE */
    ...
    override fun finish() {
        ...
        val file = FileSpec
            .builder("hk.eduhk.typeduck.core", "RimeKeyMapping")
            .addType(obj)
