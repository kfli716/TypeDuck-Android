...
package hk.eduhk.typeduck.ime.core;
...
import hk.eduhk.typeduck.data.sound.SoundThemeManager;
import hk.eduhk.typeduck.data.theme.Config;
import hk.eduhk.typeduck.databinding.CompositionRootBinding;
import hk.eduhk.typeduck.databinding.InputRootBinding;
import hk.eduhk.typeduck.ime.broadcast.IntentReceiver;
import hk.eduhk.typeduck.ime.enums.Keycode;
import hk.eduhk.typeduck.ime.enums.PopupPosition;
import hk.eduhk.typeduck.ime.enums.SymbolKeyboardType;
import hk.eduhk.typeduck.ime.keyboard.Event;
import hk.eduhk.typeduck.ime.keyboard.InputFeedbackManager;
import hk.eduhk.typeduck.ime.keyboard.Key;
import hk.eduhk.typeduck.ime.keyboard.Keyboard;
import hk.eduhk.typeduck.ime.keyboard.KeyboardSwitcher;
import hk.eduhk.typeduck.ime.keyboard.KeyboardView;
import hk.eduhk.typeduck.ime.lifecycle.LifecycleInputMethodService;
import hk.eduhk.typeduck.ime.symbol.LiquidKeyboard;
import hk.eduhk.typeduck.ime.symbol.TabManager;
import hk.eduhk.typeduck.ime.symbol.TabView;
import hk.eduhk.typeduck.ime.text.Candidate;
...
import hk.eduhk.typeduck.util.ViewUtils;
...
public class Trime extends LifecycleInputMethodService {
  ...
  private void performEscape() {
    textInputManager.hideDictionaryView();
