...
import hk.eduhk.typeduck.core.RimeEvent
...
import hk.eduhk.typeduck.ime.core.EditorInstance
import hk.eduhk.typeduck.ime.core.Trime
import hk.eduhk.typeduck.ime.enums.Keycode
import hk.eduhk.typeduck.ime.enums.Keycode.Companion.toStdKeyEvent
import hk.eduhk.typeduck.ime.enums.SymbolKeyboardType
import hk.eduhk.typeduck.ime.keyboard.Event
import hk.eduhk.typeduck.ime.keyboard.Keyboard.printModifierKeyState
...
import hk.eduhk.typeduck.util.startsWithAsciiChar
...
class TextInputManager private constructor() :
    ...
    */
    ...
    override fun onDoubleSpace(charToDel: Int, pMark: CharSequence){
        activeEditorInstance.doubleSpaceEvent(charToDel, pMark)
    }
}
